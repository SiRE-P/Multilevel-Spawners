...
(Figure S1) upstream of Osoyoos Lake. After emerging from spawning
...
spawning area---also known as the Index Section---of the Okanagan river (Figure S1) since
...
Outlet Dam (Okanagan Falls Dam in Figure S1). We have excluded these
...
counts (Figures S2, S3). Variation between the observed
...
positive relationship (Figure S4). Arrival spread and exit lag were positively correlated with a posterior median correlation of `r round(median(post$Omega[,2,4]),2)` and
