...
![The number of spawners present each day is the difference between accumulated entries and accumulated exits. From abundance: 100,000, timing: day 282, spread: 7days, residence: 10 days. Note peak count lags mean timing of entry. The integral of spawners present is the conventional AUC before correction by an assumed value for residence.](figures/method_example_no_CI.pdf){#fig-enterexit fig-alt="figures/method_example_no_CI.pdf" fig-align="center"}
...
![Posterior distributions of log(run) by year](figures/spawner_abund.pdf){#fig-runs fig-align="center"}
...
![Posterior distributions of timing, entry_spread, and exit_spread.](figures/timing_spread.pdf){#fig-timings fig-align="center"}
