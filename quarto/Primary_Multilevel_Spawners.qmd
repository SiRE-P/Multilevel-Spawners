...
abstract: |
  The abundance of spawning salmon is a fundamental variable for salmon management, but conventional methods do not estimate the precision of abundance and risk bias from an assumed residence time (to correct for observing a fish in repeated surveys). A new model estimates  timing and spread of both arrivals and exits of spawners. This model estimates of spawner residence time directly, removing a critical assumption. The model was challenged with simulated data to demonstrate robustness, and challenged with data from 291 surveys (25 years) of wild Sockeye Salmon (_Oncorhynchus nerka_) spawning in the Okanagan River (BC, Canada). Estimates of abundance were similar to conventional, but revealed relative precision. Despite how the timing and spread of arrival and exit varied between years, "effective residence" derived from our model was relatively constant and similar to the previous assumed value. Extensions to the ecology in this model could determine effects from spawner biometrics and habitat variables.
